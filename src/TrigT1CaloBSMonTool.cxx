...
/*---------------------------------------------------------*/
TrigT1CaloBSMonTool::TrigT1CaloBSMonTool(const std::string & type, 
...
/*---------------------------------------------------------*/
StatusCode TrigT1CaloBSMonTool:: initialize()
/*---------------------------------------------------------*/
{
...
/*---------------------------------------------------------*/
StatusCode TrigT1CaloBSMonTool::bookHists()
/*---------------------------------------------------------*/
{
  MsgStream log(msgSvc(), name());
  ...
  m_h_JE_eta_gt10 = book1D("JE_eta_gt10","10Gev JE eta",100,-5,5);
  ...
  m_h_CaloT_Et10 = book1D("CaloTower_Et10","CaloTower Et",100,0,10.*GeV); //Note, need to specify GeV 
  ...
  m_h_Calo_phi = book1D("Calo_phi","Calo phi",64,0,2*M_PI); 
  m_h_Calo_eta = book1D("Calo_eta","Calo eta",100,-5,5); 
  m_h_Calo_phi_gt10 = book1D("Calo_phi_gt10","Calo phi gt 10",64,0,2*M_PI); 
  m_h_Calo_eta_gt10 = book1D("Calo_eta_gt10","Calo eta gt 10",100,-5,5); 

  m_h_Calo_Em_Et10 = book1D("Calo_Em_Et10","Calo Em Et",100,0,10.*GeV); //Note, need to specify GeV 
  m_h_Calo_Em_Et = book1D("Calo_Em_Et","Calo Em Et",255,0,255.*GeV); 
  m_h_Calo_Had_Et10 = book1D("Calo_Had_Et10","Calo Had Et",100,0,10.*GeV); //Note, need to specify GeV 
  m_h_Calo_Had_Et = book1D("Calo_Had_Et","Calo Had Et",255,0,255.*GeV); 

  m_h_Calo_etaphi = book2D("Calo_Eta_Phi","Calo Eta_Phi",100,-5,5, 64, 0, 2*M_PI);
  m_h_Calo_etaphi_hitmap = book2D("Calo_Eta_Phi_HM","Calo Eta_Phi_HitMap",100,-5,5,64, 0, 2*M_PI);

  m_h_Calo_key = book1D("Calo_Key","Calo Key",100,0,8000);

  // region plots

  m_h_Barrel_Calo_Em_Et = book1D("Barrel_Calo_Em_Et", "Calo Barrel Et (Em)",100,0,100.*GeV);
  m_h_Barrel_Calo_Had_Et = book1D("Barrel_Calo_Had_Et", "Calo Barrel Et (Had)",100,0,100.*GeV);
  m_h_Barrel10_Calo_Em_Et = book1D("Barrel10_Calo_Em_Et", "Calo Barrel Et (Em, 0-10GeV)",10,0,10.*GeV);
  m_h_Barrel10_Calo_Had_Et = book1D("Barrel10_Calo_Had_Et", "Calo Barrel Et (Had, 0-10GeV)",10,0,10.*GeV);
  m_h_Barrel_Calo_phi = book1D("Barrel_Calo_phi", "Calo Barrel phi",64,0,2*M_PI);
  
  m_h_EC_Calo_Em_Et = book1D("EC_Calo_Em_Et", "Calo EC Et (Em)",100,0,100.*GeV);
  m_h_EC_Calo_Had_Et = book1D("EC_Calo_Had_Et", "Calo EC Et (Had)",100,0,100.*GeV);
  m_h_EC10_Calo_Em_Et = book1D("EC10_Calo_Em_Et", "Calo EC Et (Em, 0-10GeV)",10,0,10.*GeV);
  m_h_EC10_Calo_Had_Et = book1D("EC10_Calo_Had_Et", "Calo EC Et (Had, 0-10GeV)",10,0,10.*GeV);
  m_h_EC_Calo_phi = book1D("EC_Calo_phi", "Calo EC phi",64,0,2*M_PI);
  
  m_h_FCAL_Calo_Em_Et = book1D("FCAL_Calo_Em_Et", "Calo FCAL Et (Em)",100,0,100.*GeV);
  m_h_FCAL_Calo_Had_Et = book1D("FCAL_Calo_Had_Et", "Calo FCAL Et (Had)",100,0,100.*GeV);
  m_h_FCAL10_Calo_Em_Et = book1D("FCAL10_Calo_Em_Et", "Calo FCAL Et (Em, 0-10GeV)",10,0,10.*GeV);
  m_h_FCAL10_Calo_Had_Et = book1D("FCAL10_Calo_Had_Et", "Calo FCAL Et (Had, 0-10GeV)",10,0,10.*GeV);
  m_h_FCAL_Calo_phi = book1D("FCAL_Calo_phi", "Calo FCAL phi",64,0,2*M_PI);
  ...
  m_h_TT_Calo_Em_EtTower = book2D("TT_Calo_Em_EtTower","Calo and TT Tower Et (Em)",100,0,100.*GeV, 100, 0, 100);
  m_h_TT_Calo_Had_EtTower = book2D("TT_Calo_Had_EtTower","Calo and TT Tower Et (Had)",100,0,100.*GeV, 100, 0, 100);
  ...
  m_h_Ratio_D_Em_Et = book1D("Ratio_D_Em_Et","Calo Et / TT Et (Em)",30,0,3); 
  m_h_Ratio_D_Had_Et = book1D("Ratio_D_Had_Et","Calo Et / TT Et (Had)",30,0,3); 

  m_h_Calo_DEm_under_phi = book1D("Calo_DEm_under_phi","Calo phi (TT<Calo [Em])",64,0,2*M_PI); 
  m_h_Calo_DEm_under_eta = book1D("Calo_DEm_under_eta","Calo eta (TT<Calo [Em])",100, -5, 5); 
  m_h_Calo_DEm_under_Em_Et = book1D("Calo_DEm_under_Em_Et","Em Et Calo (TT<Calo [Em])", 255, 0, 255.*GeV);
  m_h_Calo_DEm_under_Had_Et = book1D("Calo_DEm_under_Had_Et","Had Et Calo (TT<Calo [Em])", 255, 0, 255.*GeV);
  m_h_Calo_DEm_under_TTEm_Et = book1D("Calo_DEm_under_TTEm_Et","Em Et TT (TT<Calo [Em])", 255, 0, 255.*GeV);
  m_h_Calo_DEm_under_TTHad_Et = book1D("Calo_DEm_under_TTHad_Et","Had Et TT (TT<Calo [Em])", 255, 0, 255.*GeV);

  m_h_Calo_DEm_over_phi = book1D("Calo_DEm_over_phi","Calo phi (TT>Calo [Em])",64,0,2*M_PI); 
  m_h_Calo_DEm_over_eta = book1D("Calo_DEm_over_eta","Calo eta (TT>Calo [Em])",100, -5, 5); 
  m_h_Calo_DEm_over_Em_Et = book1D("Calo_DEm_over_Em_Et","Em Et Calo (TT>Calo [Em])", 255, 0, 255.*GeV);
  m_h_Calo_DEm_over_Had_Et = book1D("Calo_DEm_over_Had_Et","Had Et Calo (TT>Calo [Em])", 255, 0, 255.*GeV);
  m_h_Calo_DEm_over_TTEm_Et = book1D("Calo_DEm_over_TTEm_Et","Em Et TT (TT>Calo [Em])", 255, 0, 255.*GeV);
  m_h_Calo_DEm_over_TTHad_Et = book1D("Calo_DEm_over_TTHad_Et","Had Et TT (TT>Calo [Em])", 255, 0, 255.*GeV);

  m_h_Calo_DHad_under_phi = book1D("Calo_DHad_under_phi","Calo phi (TT<Calo [Em])",64,0,2*M_PI); 
  m_h_Calo_DHad_under_eta = book1D("Calo_DHad_under_eta","Calo eta (TT<Calo [Em])",100, -5, 5); 
  m_h_Calo_DHad_under_Em_Et = book1D("Calo_DHad_under_Em_Et","Em Et Calo (TT<Calo [Em])", 255, 0, 255.*GeV);
  m_h_Calo_DHad_under_Had_Et = book1D("Calo_DHad_under_Had_Et","Had Et Calo (TT<Calo [Em])", 255, 0, 255.*GeV);
  m_h_Calo_DHad_under_TTEm_Et = book1D("Calo_DHad_under_TTEm_Et","Em Et TT (TT<Calo [Em])", 255, 0, 255.*GeV);
  m_h_Calo_DHad_under_TTHad_Et = book1D("Calo_DHad_under_TTHad_Et","Had Et TT (TT<Calo [Em])", 255, 0, 255.*GeV);

  m_h_Calo_DHad_over_phi = book1D("Calo_DHad_over_phi","Calo phi (TT>Calo [Em])",64,0,2*M_PI); 
  m_h_Calo_DHad_over_eta = book1D("Calo_DHad_over_eta","Calo eta (TT>Calo [Em])",100, -5, 5); 
  m_h_Calo_DHad_over_Em_Et = book1D("Calo_DHad_over_Em_Et","Em Et Calo (TT>Calo [Em])", 255, 0, 255.*GeV);
  m_h_Calo_DHad_over_Had_Et = book1D("Calo_DHad_over_Had_Et","Had Et Calo (TT>Calo [Em])", 255, 0, 255.*GeV);
  m_h_Calo_DHad_over_TTEm_Et = book1D("Calo_DHad_over_TTEm_Et","Em Et TT (TT>Calo [Em])", 255, 0, 255.*GeV);
  m_h_Calo_DHad_over_TTHad_Et = book1D("Calo_DHad_over_TTHad_Et","Had Et TT (TT>Calo [Em])", 255, 0, 255.*GeV);
  ...
  //TT:
  m_h_Calib_TTEM_EtEta = book2D("TTEM_EtEta", "TT (EM) Et vs eta", 50, -5, 5, 10, 0, 10);
  m_h_Calib_TTHAD_EtEta = book2D("TTHAD_EtEta", "TT (HAD) Et vs eta", 50, -5, 5, 10, 0, 10);
  //CaloTower
  m_h_Calib_CaloT_EtEta = book2D("CaloT_EtEta", "ESD Calo Et vs eta", 50, -5, 5, 100, 0, 10.*GeV);
  
  //need to add TSCT Em and Had
  m_h_Calib_CaloEM_EtEta = book2D("CaloEM_EtEta", "TSCT (EM) Et vs eta", 50, -5, 5, 100, 0, 10.*GeV);
  m_h_Calib_CaloHAD_EtEta = book2D("CaloHAD_EtEta", "TSCT (HAD) Et vs eta", 50, -5, 5, 100, 0, 10.*GeV);
  
  //Not implemented
  m_h_Calib_EMRatio_ETEta = book2D("CalibEM_EtEta", "Calib (EM) Et vs eta", 50, -5, 5, 2, 0, 2);
  m_h_Calib_HADRatio_ETEta = book2D("CalibHAD_EtEta", "Calib (HAD) Et vs eta", 50, -5, 5, 2, 0, 2);
...
/*---------------------------------------------------------*/
StatusCode TrigT1CaloBSMonTool::fillHists()
/*---------------------------------------------------------*/
{
  MsgStream log(msgSvc(), name());
  ...
  */
  ...
  log << MSG::ERROR << "Ethan:: before Trigger Loop"<<endreq;
  ...
  for (; TriggerTowerIterator != TriggerTowerIteratorEnd; ++TriggerTowerIterator) 
  {
    ...
    log << MSG::ERROR << "Ethan:: EmEt = "<<(*TriggerTowerIterator)->emEnergy()<<endreq;
...
/*---------------------------------------------------------*/
StatusCode TrigT1CaloBSMonTool::finalHists()
/*---------------------------------------------------------*/
{
  MsgStream log(msgSvc(), name());
...
/*---------------------------------------------------------*/
StatusCode TrigT1CaloBSMonTool::checkHists(bool /* fromFinalize */)
/*---------------------------------------------------------*/
{
  MsgStream log(msgSvc(), name());
...
TH1D* TrigT1CaloBSMonTool::book1D(std::string nam, std::string tit, int nx, double xmin, double xmax){
...
TH2D* TrigT1CaloBSMonTool::book2D(std::string nam, std::string tit, int nx, double xmin, double xmax,  
