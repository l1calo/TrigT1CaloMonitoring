...
//    
// ================= "Calorimeter -> PPr" ==============================================
// Check	"Transmission & Functionality" ("soft" comparison)
//            TriggerTowerTool(CaloTower) ~ PPrDAQ.TriggerTowers (Compare distributions)
...
/*---------------------------------------------------------*/
{
  declareProperty("CompWithCalorimeter",  m_CompWithCalo = 0);
...
/*---------------------------------------------------------*/
{
  ...
  MonGroup Calo_Tower( this, (m_PathInRootFile+"_CalorimeterData").c_str(), shift, eventsBlock );
  HistoBooker* CaloTower_Booker = new HistoBooker(&Calo_Tower, &log, m_DataType);

  MonGroup Calo_HitMaps( this, (m_PathInRootFile+"_CaloTTHitMaps").c_str(), shift, eventsBlock );
