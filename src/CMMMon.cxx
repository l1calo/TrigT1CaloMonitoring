...
/*---------------------------------------------------------*/
{
  ...
  MonGroup CMM_DAQ ( this, (m_PathInRootFile+"/DAQ").c_str(), shift, eventsBlock );
  ...
  MonGroup CMM_RoI ( this, (m_PathInRootFile + "/RoI").c_str(), shift, eventsBlock );
  ...
  if( isNewEventsBlock || isNewLumiBlock ) 
    {	
      // CMM Jet Hits
      m_h_CMMJetHits_MainJets = DAQ_Booker->book1F("TotalMainHits_CMM_DAQ", "Total Main Hits  --  CMM DAQ", 
						   8, -0.5, 7.5, "Threshold No.", "#");
      m_h_CMMJetHits_FwdJetsRight = DAQ_Booker->book1F("TotalFwdHitsRight_CMM_DAQ", "Total Forward Hits Right  --  CMM DAQ",
						       4 , -0.5, 3.5, "Threshold No.", "#");
      m_h_CMMJetHits_FwdJetsLeft = DAQ_Booker->book1F("TotalFwdHitsLeft_CMM_DAQ", "Total Forward Hits Left  --  CMM DAQ",
						      4 , -0.5, 3.5,  "Threshold No.", "#");
      // JEM Hits
      m_h_CMMJetHits_JEM_MainHits=input_Booker->book1F("MainHits_CMM_input", "Main Hits  --  CMM input", 
						       8, -0.5, 7.5, "Threshold No.", "#");
      m_h_CMMJetHits_JEM_FwdHitsRight=input_Booker->book1F("FwdHitsRight_CMM_input", "Forward Hits Right  --  CMM input",
							   4 , -0.5, 3.5, "Threshold No.", "#");
      m_h_CMMJetHits_JEM_FwdHitsLeft=input_Booker->book1F("FwdHitsLeft_CMM_input", "Forward Hits Left  --  CMM input",
							  4 , -0.5, 3.5,  "Threshold No.", "#");
      ...
      // CMM Et Sums
      m_h_CMMEtSums_Ex = DAQ_Booker->book1F("Ex_CMM_DAQ", "Ex  --  CMM DAQ", 250, 0,250, "Ex [GeV]", "#");
      m_h_CMMEtSums_Ey = DAQ_Booker->book1F("Ey_CMM_DAQ", "Ey  --  CMM DAQ", 250, 0,250, "Ex [GeV]", "#");
      m_h_CMMEtSums_Et = DAQ_Booker->book1F("Et_CMM_DAQ", "Et  --  CMM DAQ", 250, 0,250, "Ex [GeV]", "#");
      
      m_h_CMMJetHits_EtMap = DAQ_Booker->book1F("JetEtHits_CMM_DAQ", "Jet Et Hits  --  CMM DAQ", 
						4 ,-0.5, 3.5, "Threshold No.", "#");
      m_h_CMMEtSums_MissingEtMap = DAQ_Booker->book1F("MissingEtHits_CMM_DAQ", "Missing Et Hits  --  CMM DAQ", 
						      8, -0.5, 7.5, "Threshold No.", "#");
      m_h_CMMEtSums_SumEtMap = DAQ_Booker->book1F("SumEtHits_CMM_DAQ", "Sum Et Hits  --  CMM DAQ", 
						  4, -0.5, 3.5, "Threshold No.", "#");
   // JEM Et Sums
      m_h_CMMEtSums_JEM_Ex=input_Booker->book1F("Ex_CMM_input", "Ex  --  CMM input", 250, 0,250, "Ex [GeV]", "#");
      m_h_CMMEtSums_JEM_Ey=input_Booker->book1F("Ey_CMM_input", "Ey  --  CMM input", 250, 0,250, "Ex [GeV]", "#");
      m_h_CMMEtSums_JEM_Et=input_Booker->book1F("Et_CMM_input", "Et  --  CMM input", 250, 0,250, "Ex [GeV]", "#");
      
      // CMM RoI
      m_h_CMMRoI_Ex = RoI_Booker->book1F("Ex_CMM_RoI", "Ex  --  CMM RoI", 250, 0,250, "Ex [GeV]", "#");
      m_h_CMMRoI_Ey = RoI_Booker->book1F("Ey_CMM_RoI", "Ey  --  CMM RoI", 250, 0,250, "Ex [GeV]", "#");
      m_h_CMMRoI_Et = RoI_Booker->book1F("Et_CMM_RoI", "Et  --  CMM RoI", 250, 0,250, "Ex [GeV]", "#");
      
      m_h_CMMRoI_JetEtHits =RoI_Booker->book1F("JetEtHits_CMM_RoI","Jet Et Hits  --  CMM RoI",
					       4, -0.5,3.5,"Threshold No.","#");
      m_h_CMMRoI_MissingEtHits =RoI_Booker->book1F("MissingEtHits_CMM_RoI","Missing Et Hits  --  CMM RoI",
						   8, -0.5,7.5,"Threshold No.","#");
      m_h_CMMRoI_SumEtHits =RoI_Booker->book1F("SumEtHits_CMM_RoI","Sum EtHits  --  CMM RoI",
					       4, -0.5,3.5,"Threshold No.","#");
      
      //transmission checks
      m_h_TransmissionCheck_Crate0_Hits= transmission_Booker->book1F("TransmCheck_JEMCMM_Crate0_Hits", "Transmission Check JEM->CMM: Crate0 Hits", 17, -0.5, 16.5, "Module No.", "#");
      m_h_TransmissionCheck_Crate1_Hits= transmission_Booker->book1F("TransmCheck_JEMCMM_Crate1_Hits", "Transmission Check JEM->CMM: Crate1 Hits", 17, -0.5, 16.5, "Module No.", "#");

      m_h_TransmissionCheck_Crate0_Energy= transmission_Booker->book1F("TransmCheck_JEMCMM_Crate0_Energy", "Transmission Check JEM->CMM: Crate0 Energy", 17, -0.5, 16.5, "Module No.", "#");
      m_h_TransmissionCheck_Crate1_Energy= transmission_Booker->book1F("TransmCheck_JEMCMM_Crate1_Energy", "Transmission Check JEM->CMM: Crate1 Energy", 17, -0.5, 16.5, "Module No.", "#");
    }
		...
		if ((*it_vCMMJEMHits).Hits()!=(*it_vJEMHits).JetHits())
		  {
		    ...
		    if ((*it_vJEMHits).crate()==0) m_h_TransmissionCheck_Crate0_Hits-> Fill((*it_vJEMHits).module(),1);
		    else m_h_TransmissionCheck_Crate1_Hits-> Fill((*it_vJEMHits).module(),1);
	...
	for( it_vCMMJEMHits  = vCMMJEMHits.begin(); it_vCMMJEMHits <  vCMMJEMHits. end(); ++it_vCMMJEMHits )
	  {
	    ...
	    if ((*it_vCMMJEMHits).crate()==0) m_h_TransmissionCheck_Crate0_Hits-> Fill((*it_vCMMJEMHits).dataID(),1);
	    else m_h_TransmissionCheck_Crate1_Hits-> Fill((*it_vCMMJEMHits).dataID(),1);
	  }
      }
	...
	while ((found==0)and(it_vJEMEtSums<vJEMEtSums.end()))
	  {
		...
		if (((*it_vCMMJEMEtSums).Ex()!=(*it_vJEMEtSums).Ex())
		    ...
		    or ((*it_vCMMJEMEtSums).Et()!=(*it_vJEMEtSums).Et()))
		  {
		    ...
		    if ((*it_vJEMEtSums).crate()==0) m_h_TransmissionCheck_Crate0_Energy-> Fill((*it_vJEMEtSums).module(),1);
		    else m_h_TransmissionCheck_Crate1_Energy-> Fill((*it_vJEMEtSums).module(),1);
	...
	for( it_vCMMJEMEtSums  = vCMMJEMEtSums.begin(); it_vCMMJEMEtSums <  vCMMJEMEtSums. end(); ++it_vCMMJEMEtSums )
	  {
	    ...
	    if ((*it_vCMMJEMEtSums).crate()==0) m_h_TransmissionCheck_Crate0_Energy-> Fill((*it_vCMMJEMEtSums).dataID(),1);
	    else m_h_TransmissionCheck_Crate1_Energy-> Fill((*it_vCMMJEMEtSums).dataID(),1);
	  }
      }
